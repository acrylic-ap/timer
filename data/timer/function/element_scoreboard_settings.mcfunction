...
scoreboard objectives add timer_time_by_second dummy
scoreboard objectives add timer_time_by_minute dummy
...
scoreboard objectives add target_timer_time dummy

scoreboard objectives add passed_sound dummy
scoreboard objectives add failed_sound dummy