...
# 타이머
execute as @e[type=block_display,tag=timer,limit=1] at @s run execute if entity @s[scores={timer_start=1, timer_type=1, timer_time=..0}] run title @a actionbar "Time Over!"
