...
$scoreboard players set @e[type=block_display, tag=timer] target_timer_time $(minutes)
execute as @e[type=block_display, tag=timer] at @s run scoreboard players operation @s target_timer_time *= @s sixty
$scoreboard players add @e[type=block_display, tag=timer] target_timer_time $(seconds)
execute as @e[type=block_display, tag=timer] at @s run scoreboard players operation @s target_timer_time *= @s twenty
